...
\author{C.\ David Williams\inst{1} \and Magdalena Balazinska\inst{1} \and Thomas Daniel\inst{1}}
\institute{Department of Biology, University of Washington, Seattle WA 98195, USA, \\
  \email{cdave@uw.edu}
  }
\maketitle
